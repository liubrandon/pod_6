...
# Printing each variable listed above
print(box_1)
print(box_2)
print(box_3)
print(box_4)
...
# Creating a new variable named address and assigning it a street name
address = "Main Street"
...
#Reassign variable box_2 and box_4
box_2 = 'candy'
box_4 = 'movies'
print(box_1)
print(box_2)
...
# Fixed syntax errors and create new variable
