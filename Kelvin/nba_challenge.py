...
print(fred_van_vleet_3pts_made)
...
jamal_murray_percentage = 46 / 93
print(jamal_murray_percentage)
fred_van_vleet_percentage = 45 / 110
print(fred_van_vleet_percentage)
james_harden_perfectage = 46 / 109
print(james_harden_perfectage)
...
lakers_are_best = 99.9 
print(lakers_are_best)

#Challenge 3.5 Type conversion part 2
print(str(jamal_murray_percentage))
print(str(fred_van_vleet_percentage))
print(str(james_harden_perfectage))

print(int(jamal_murray_percentage))
print(int(fred_van_vleet_percentage))
print(int(james_harden_perfectage))