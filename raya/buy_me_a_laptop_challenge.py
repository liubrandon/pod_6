...
laptops[0]['types'][0]['colors'] = 'Silver','Sagey Purple'
...
print(laptops[0]['productName'], laptops[0]['types'][0]['screen_size'], laptops[0]['types'][0]['price'])
print(laptops[0]['productName'], laptops[0]['types'][1]['screen_size'], laptops[0]['types'][1]['price'])
print(laptops[1]['productName'], laptops[1]['types'][1]['screen_size'], laptops[1]['types'][0]['price'])
print(laptops[1]['productName'], laptops[1]['types'][0]['screen_size'], laptops[1]['types'][1]['price'])
