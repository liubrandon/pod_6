...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'Subway lines {self.lines} stop at {self.station_name} Station at {self.location}.')
...
lines: ['1', '2', '3', 'L']
'''
subway1 = SubwayStation(station_name='14th street', location='14th street and 7th avenue', lines=['1', '2', '3', 'L'])
subway1.show_info()
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} located at {self.location} will go to {self.routes}.')

        if self.open == True:
            print('These routes are open.')
        else:
            print('These routes are closed')
...
BusStation1 = BusStation('NYC Megabus Stop', '34th street and 12th avenue', ['Boston', 'DC', 'Philly'])
BusStation1.show_info()
